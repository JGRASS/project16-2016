...
public class Kontroler {	
	...
	/**
	 * Predstavlja spisak({@link SpisakProizvoda}) svih proizvoda({@link Proizvod}) koji se prodaju u prodavnici.
	 * 
	 * @author Milos Cvetkovic
	 */
	...
	/**
	 * Vraca spisak({@link SpisakProizvoda}) proizvoda({@link Proizvod}) koji koristi prodavnica.
	 * 
	...
	/**
	 * Dodaje novi proizvod({@link Proizvod}) u spisak({@link SpisakProizvoda}) i fajl spisak.out.
	 * 
	...
	/**
	 * Brise zadati proizvod({@link Proizvod}) iz spiska({@link SpisakProizvoda}) i fajla spisak.out.
	 * 
	...
	/**
	 * Kreira i vraca model za tabelu na osnovu spiska({@link SpisakProizvoda}) proizvoda({@link Proizvod}).
	...
	/**
	 * Dodaje zadati proizvod({@link Proizvod}) u spisak({@link SpisakProizvoda}) i fajl spisak.out.
	 * Ukoliko proizvod vec postoji onda mu se samo azurira cena.
	 * 
	 * @param table {@link JTable}
	 * @param panel {@link JPanel}
	 * @param model {@link Model}
